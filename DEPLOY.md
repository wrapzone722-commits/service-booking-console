...
**С SMS (оплата у провайдера):** задайте `SMS_API_KEY` (api_id с [SMS.ru](https://sms.ru)) и `SMS_SENDER` — тогда код уходит в SMS на указанный номер. Мастер-код верификации (`SECRET_VERIFICATION_CODE`, по умолчанию 230490) действует и для входа по коду.
