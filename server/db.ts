...
function initDb() {
  ...
  const services: Service[] = [
    ...
    },
    {
      ...
      description: "Быстрая мойка и сушка кузова.",
      price: 1500,
      duration: 30,
      category: "Мойка",
      image_url: null,
    ...
    },
    {
      _id: "svc_3",
      name: "Полировка лака",
      description: "Защитная полировка кузова.",
      price: 2500,
      duration: 45,
      category: "Полировка",
      image_url: null,
  ...
  services.forEach((s) => db.services.set(s._id, s));

  // Posts (car wash bays)
  const posts: Post[] = [1, 2, 3, 4].map((n) => ({
    _id: `post_${n}`,
    name: `Пост ${n}`,
    is_enabled: true,
  ...
  posts.forEach((p) => {
    db.posts.set(p._id, p);
    db.closedSlotsByPost.set(p._id, new Set());
  });
  ...
  const users: User[] = [
    ...
    },
    {
      ...
      avatar_url: null,
      social_links: { whatsapp: "+79000000002" },
      created_at: "2025-01-15T14:00:00Z",
    },
  ];

  users.forEach((u) => db.users.set(u._id, u));
  ...
  const bookings: Booking[] = [
    {
      ...
      user_id: "usr_1",
      user_name: "Алекс Иванов",
      post_id: "post_1",
      date_time: "2025-02-05T14:30:00Z",
      status: "pending",
      price: 4500,
      duration: 60,
      notes: null,
    ...
    },
    {
      _id: "bkg_2",
      service_id: "svc_2",
      service_name: "Экспресс мойка кузова",
      user_id: "usr_2",
      ...
      price: 1500,
      duration: 30,
      notes: "Клиент просил ранний слот",
      created_at: "2025-01-30T10:00:00Z",
    },
    {
      _id: "bkg_3",
      service_id: "svc_3",
      service_name: "Полировка лака",
      user_id: "usr_3",
      user_name: "Иван Сидоров",
      post_id: "post_1",
      date_time: "2025-02-03T11:00:00Z",
      status: "in_progress",
      price: 2500,
      duration: 45,
      notes: null,
  ...
  bookings.forEach((b) => db.bookings.set(b._id, b));

  // Sample device connections
  const deviceConnections: DeviceConnection[] = [
    {
      _id: "dev_1704067200000_abc123def",
      device_id: "uuid-iphone-alex-001",
      device_name: "iPhone 15 Pro (Алекс)",
      client_id: "usr_1",
      ...
      status: "connected",
      last_seen: "2025-01-31T10:30:00Z",
      created_at: "2025-01-15T09:00:00Z",
    },
    {
      _id: "dev_1704153600000_def456ghi",
      device_id: "uuid-ipad-maria-002",
      device_name: "iPad Air (Мария)",
      client_id: "usr_2",
      ...
      status: "connected",
      last_seen: "2025-01-30T15:45:00Z",
      created_at: "2025-01-20T11:00:00Z",
    },
    {
      _id: "dev_1704240000000_ghi789jkl",
      device_id: "uuid-iphone-ivan-003",
      ...
      status: "pending",
      last_seen: "2025-01-31T08:00:00Z",
      created_at: "2025-01-28T14:00:00Z",
    },
    {
      _id: "dev_1704326400000_jkl012mno",
      device_id: "uuid-iphone-test-004",
  ...
  deviceConnections.forEach((dc) => db.deviceConnections.set(dc._id, dc));
}
