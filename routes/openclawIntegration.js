...
export function getOpenclawManifest(req, res) {
  ...
  const adminEndpoints = [
    ...
    {
      id: 'printer_settings_get',
      method: 'GET',
      path: '/printer',
      requires_admin_key: true,
      description: 'Настройки термопринтера LAN (enabled, host, port, header_line)',
    },
    {
      id: 'printer_settings_put',
      method: 'PUT',
      path: '/printer',
      requires_admin_key: true,
      body: { enabled: 'boolean', host: 'string', port: 'number', header_line: 'string' },
    },
    {
      id: 'print_test',
      method: 'POST',
      path: '/print/test',
      requires_admin_key: true,
      description: 'Тестовая полоска ESC/POS на принтер по TCP',
    },
    {
      id: 'print_receipt',
      method: 'POST',
      ...
      description: 'Чек по записи (не cancelled); LAN ESC/POS',
    },
    {
      id: 'clients_list',
      method: 'GET',
